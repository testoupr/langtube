...
Transform YouTube videos into interactive learning experiences with automatic transcript fetching, AI-powered summarization, and quiz generation.

## 🆕 NEW: Supadata Integration

**Automatic YouTube Transcript Fetching!** No more manual copying - just paste a YouTube URL and get started instantly!

## Features

✨ **Automatic YouTube Integration**
- Paste any YouTube URL to get started
- **Automatic transcript fetching** using Supadata API
...
### 🚀 Quick Start with Supadata (Recommended)

**Automatic transcript fetching!** No more manual copying.

1. **Get Supadata API Key:**
   - Visit [Supadata Dashboard](https://dash.supadata.ai)
   - Sign up for free
   - Get your API key
...
2. **Install and Run:**
   ...
   npm install
   cp env.example .env
   # Edit .env and add your SUPADATA_API_KEY
   npm start
   ```
...
1. **With Supadata Integration (Recommended):**
   - Paste any YouTube URL
   - Click "Fetch Transcript" 
   - Get automatic transcript and start learning!

2. **Manual Fallback:**
   - If automatic fetching fails, paste transcript manually
   - Still works with all the same AI features
